...
from homepage.views import index, recipe_detail, author_detail, recipe_submit, author_submit, login_view, signup_view, logout_view, edit_recipe, add_favorite
...
urlpatterns = [
    ...
    path('addfavorite/<int:recipe_id>/<int:author_id>', add_favorite, name='add_favorite'),
